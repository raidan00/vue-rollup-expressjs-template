...
(function () {
    ...
    const _withScopeId = n => (pushScopeId("data-v-278f674b"),n=n(),popScopeId(),n);
    const _hoisted_1 = ["onSubmit"];
    const _hoisted_2 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createBaseVNode("button", null, "send to server", -1 /* HOISTED */));
    ...
    return (_ctx, _cache) => {
      return (openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("form", {
          onSubmit: withModifiers(sendToServer, ["prevent"])
        }, [
          withDirectives(createBaseVNode("input", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => ((str).value = $event))
          }, null, 512 /* NEED_PATCH */), [
            [vModelText, str.value]
          ]),
          _hoisted_2
        ], 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_1),
        (reversedStr.value)
          ? (openBlock(), createElementBlock("div", _hoisted_3, " Str from server: \"" + toDisplayString(reversedStr.value) + "\" ", 1 /* TEXT */))
    ...
    script.__scopeId = "data-v-278f674b";
    script.__file = "client/App.vue";
